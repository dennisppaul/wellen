...
/**
 * this example demonstrates how to use a beat triggered by an external MIDI beat clock ( e.g generated by an external
 * MIDI device or an internal MIDI application ).
 */
