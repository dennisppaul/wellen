 ...
 * of a ton over time. it is started by calling the `note_on()` method and released by calling the `note_off()` method.
 * <p>
...
public class ExampleInstruments01ADSR extends PApplet {
    ...
    public static void main(String[] args) {
        PApplet.main(ExampleInstruments01ADSR.class.getName());
    }
}
