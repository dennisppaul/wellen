...
import wellen.Beat;
import wellen.NoteEvents;
import wellen.Tone;
import wellen.Wellen;

public class TechniqueBasics07NoteEvents extends PApplet {

    /*
     * this example demonstrates how to use note events to create a composition.
     */

    private final NoteEvents fEvents = new NoteEvents();
    ...
    private final int mBaseNoteDefault = 36;
    private int mBaseNote = mBaseNoteDefault;
    private final int mBaseNoteIncrease = 7;
    private final int mBaseNoteIncreaseMax = 2;
    ...
    public static void main(String[] args) {
        PApplet.main(TechniqueBasics07NoteEvents.class.getName());
    }
}
