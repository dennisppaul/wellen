...
public class EventReceiverOSC {
    ...
    public static final int EVENT_OSC_NOTE_ON = 0;
    public static final int EVENT_OSC_NOTE_OFF = 1;
    public static final int EVENT_OSC_CONTROLCHANGE = 2;
    public static final int EVENT_OSC_PITCHBAND = 3;
