 ...
 */
public class SketchExampleDSP06LowFrequencyOscillator extends PApplet {
    ...
    private final float mBaseFrequency = 2.0f * DSP.DEFAULT_SAMPLING_RATE / DSP.DEFAULT_AUDIOBLOCK_SIZE;
    ...
    public static void main(String[] args) {
        PApplet.main(SketchExampleDSP06LowFrequencyOscillator.class.getName());
    }
}