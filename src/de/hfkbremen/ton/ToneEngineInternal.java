...
import static de.hfkbremen.ton.Ton.DEFAULT_AUDIO_DEVICE;
import static de.hfkbremen.ton.Ton.DEFAULT_SAMPLING_RATE;
import static de.hfkbremen.ton.Ton.NO_CHANNELS;
...
public class ToneEngineInternal extends ToneEngine implements AudioBufferRenderer {
    ...
    public ToneEngineInternal() {
        this(DEFAULT_SAMPLING_RATE, DEFAULT_AUDIO_DEVICE, 2);
    }

    public static ToneEngineInternal no_output() {
        return new ToneEngineInternal(DEFAULT_SAMPLING_RATE, DEFAULT_AUDIO_DEVICE, NO_CHANNELS);
    }
