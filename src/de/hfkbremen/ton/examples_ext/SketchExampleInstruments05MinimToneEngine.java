 ...
 * is very similar to the jsyn library ). if running this sketch from processing PDE add `import ddf.minim.*;` to the
 * imports.
 */
public class SketchExampleInstruments05MinimToneEngine extends PApplet {
    ...
    public static void main(String[] args) {
        PApplet.main(SketchExampleInstruments05MinimToneEngine.class.getName());
    }
}
