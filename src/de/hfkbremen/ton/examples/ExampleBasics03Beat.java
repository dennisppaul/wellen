...
/**
 * this examples demonstrates how to use a beat. once started the method `beat(int)` is called at a speed defined in
 * *beats per minute* (bpm) ( i.e quartner notes per minute ).
 */
