...
public class TestSAMTuningPhonemeLoops extends PApplet {
    ...
    public void setup() {
        ...
        mWords = new SingFragment[]{new SingFragment("EH", Note.NOTE_C3, 2, 0.50241286f, 0.8981233f),
                                    ...
                                    new SingFragment("AY", Note.NOTE_F3, 2, 0.07763485f, 0.3692169f),
                                    new SingFragment("SIYIY", Note.NOTE_G3, 2, 0.49991727f, 0.89988416f),
                                    new SingFragment("YUW", Note.NOTE_F3, 2, 0.5f, 0.9f),
                                    new SingFragment("FAO", Note.NOTE_D3 + 1, 2, 0.5917517f, 0.98083735f),
                                    new SingFragment("LIHNX", Note.NOTE_F3, 1, 0.4180811f, 0.61693764f),
                                    new SingFragment("", Note.NOTE_F3, 1, 0.5f, 0.9f),

                                    new SingFragment("AY", Note.NOTE_C3, 1, 0.07763485f, 0.3692169f),
                                    new SingFragment("GEHT", Note.NOTE_A3 + 1, 2, 0.5871952f, 0.64489114f),
                                    new SingFragment("DAWN", Note.NOTE_G3 + 1, 2, 0.6535342f, 0.76152956f),
                                    new SingFragment("AAN", Note.NOTE_G3, 1, 0.028384725f, 0.5691239f),
                                    new SingFragment("MAY", Note.NOTE_F3, 2, 0.36823878f, 0.59779024f),
                                    new SingFragment("NIYZ", Note.NOTE_D3 + 1, 2, 0.42345494f, 0.60453105f),
                                    new SingFragment("AEND", Note.NOTE_F3, 2, 0.10612828f, 0.34875825f),
                                    new SingFragment("PREY", Note.NOTE_C3, 2, 0.56590533f, 0.7307875f),
