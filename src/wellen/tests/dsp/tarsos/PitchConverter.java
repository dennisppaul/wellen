...
public final class PitchConverter {
    ...
    /**
     * Returns the frequency (Hz) of an absolute cent value. This calculation uses a configured reference frequency.
     *
    ...
    /**
     * Converts cent values to ratios. See "Ratios Make Cents: Conversions from ratios to cents and back again" in the
     * book "Tuning Timbre Spectrum Scale" William A. Sethares.
     *
    ...
    /**
     * The reference frequency is configured. The default reference frequency is 16.35Hz. This is C0 on a piano keyboard
     * with A4 tuned to 440 Hz. This means that 0 cents is C0; 1200 is C1; 2400 is C2; ... also -1200 cents is C-1
     *
    ...
    /**
     * A MIDI key is an integer between 0 and 127, inclusive. Within a certain range every pitch is mapped to a MIDI
     * key. If a value outside the range is given an IllegalArugmentException is thrown.
     *
     * @param hertzValue The pitch in Hertz.
     * @return An integer representing the closest midi key.
     * @throws IllegalArgumentException if the hertzValue does not fall within the range of valid MIDI key frequencies.
     */
    ...
    /**
     * Converts a Hertz value to relative cents. E.g. 440Hz is converted to 900 if the reference is a C.
     *
     ...
     * @throws IllegalArgumentException If midiKey is not in the valid range between 0 and 127, inclusive.
     */
    public static double midiKeyToHertz(final int midiKey) {
        if (midiKey < 0 || midiKey > 127) {
            throw new IllegalArgumentException("MIDI keys are values from 0 to 127, inclusive " + midiKey + " is " +
                                                       "invalid.");
        }
    ...
    /**
     * Converts a ratio to cents. "Ratios Make Cents: Conversions from ratios to cents and back again" in the book
