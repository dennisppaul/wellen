...
import wellen.extern.daisysp.StringVoice;

public class TestDaisySPStringVoice extends PApplet {
    ...
    public void beat(int pBeatCount) {
        mStringVoice.Trig();
        mStringVoice.SetFreq(wellen.extern.daisysp.DSP.mtof(mMIDINotes[mMIDINoteCounter]));
        mMIDINoteCounter++;
    ...
    public static void main(String[] args) {
        PApplet.main(TestDaisySPStringVoice.class.getName());
    }
}
