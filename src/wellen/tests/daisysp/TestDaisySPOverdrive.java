...
import wellen.extern.daisysp.Overdrive;
import wellen.extern.daisysp.Pluck;
import wellen.extern.daisysp.ReverbSc;

public class TestDaisySPOverdrive extends PApplet {
    ...
    public static void main(String[] args) {
        PApplet.main(TestDaisySPOverdrive.class.getName());
    }
}
