...
public class RRStompBox {
    ...
    public RRStompBox(float[] efxoutl_, float[] efxoutr_) {
        efxoutl = efxoutl_;
        efxoutr = efxoutr_;
        ...
        linput = new RRAnalogFilter(1, 80.0f, 1.0f,
                                    0);  //  RRAnalogFilter (unsigned char Ftype, float Ffreq, float Fq,unsigned char
        // Fstages);
        ...
        rinput = new RRAnalogFilter(1, 80.0f, 1.0f,
                                    0);  //  RRAnalogFilter (unsigned char Ftype, float Ffreq, float Fq,unsigned char
        // Fstages);
