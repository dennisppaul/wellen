...
/**
 * <p>
 * A pitch extractor that extracts the Average Magnitude Difference (AMDF) from an audio buffer. This is a good measure
 * of the Pitch (f0) of a signal.
 * </p>
 * <p>
 * AMDF is calculated by the the difference between the waveform summing a lagged version of itself.
 * </p>
 * <p>
 * The main bulk of the code is written by Eder de Souza for the <a href="http://jaudio.sf.net">jAudio</a> framework.
 * Adapted for TarsosDSP by Joren Six.
 * </p>
 *
...
public class AMDF implements PitchDetector {
    ...
    public PitchDetectionResult getPitch(float[] audioBuffer) {
        ...
        double search_length = minPeriod / 2.0f;
        minval = amd[j];
        int minpos = j;
        int i = j;
