...
//                final float u = 2.0f * rand() - 1.0f;
                u = 2.0f * DSP.randf() - 1.0f;
                final float f = DSP.fmin(DSP.powf(2.f, kRatioFrac * spread_ * u) * frequency_, .25f);
                pre_gain_ = 0.5f / DSP.sqrtf(resonance_ * f * DSP.sqrtf(density_));
    ...
    public void SetFreq(float freq) {
        freq /= sample_rate_;
        frequency_ = DSP.fclamp(freq, 0.f, 1.f);
    }
    ...
    public void SetResonance(float resonance) {
        resonance_ = DSP.fclamp(resonance, 0.f, 1.f);
    }
    ...
    public void SetRandomFreq(float freq) {
        freq /= sample_rate_;
        rand_freq_ = DSP.fclamp(freq, 0.f, 1.f);
    }
    ...
    public void SetDensity(float density) {
        density_ = DSP.fclamp(density * .3f, 0.f, 1.f);
    }
