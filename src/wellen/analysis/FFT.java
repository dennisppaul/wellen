...
public final class FFT {
    ...
    /**
     * Returns the modulus of the element at index bufferCount. The modulus, magnitude or absolute value is (a²+b²) ^
     * 0.5 with a being the real part and b the imaginary part of a complex number.
     *
     ...
     *
     * @param data  The FFT transformed data.
     * @param power The array where the magnitudes or powers are going to be stored. It is half the length of data (FFT
     *              size).
    ...
    /**
     * Computes 1D Discrete Fourier Transform (DFT) of complex and real, single precision data. The size of the data can
     * be an arbitrary number. This is a parallel implementation of split-radix and mixed-radix algorithms optimized for
     * SMP systems.
     * <br>
     * This code is derived from <a href="http://www.kurims.kyoto-u.ac.jp/~ooura/fft.html">General Purpose FFT
     * Package</a> written by Takuya Ooura and from <a href="http://jfftpack.sourceforge.net/">JFFTPack</a> written by
     * Baoshe Zhang
     *
     * @author Piotr Wendykier (piotr.wendykier@gmail.com)
     */
    private static strictfp class FloatFFT {
        ...
        /**
         * Computes 1D forward DFT of real data leaving the result in <code>a</code> . This method computes the full
         * real forward transform, i.e. you will get the same result as from <code>complexForward</code> called with all
         * imaginary parts equal 0. Because the result is stored in <code>a</code>, the size of the input array must
         * greater or equal 2*n, with only the first n elements filled with real data. To get back the original data,
         * use
         ...
         * Computes 1D forward DFT of real data leaving the result in <code>a</code> . This method computes the full
         * real forward transform, i.e. you will get the same result as from <code>complexForward</code> called with all
         * imaginary part equal 0. Because the result is stored in <code>a</code>, the size of the input array must
         * greater or equal 2*n, with only the first n elements filled with real data. To get back the original data,
         * use
         * <code>complexInverse</code> on the output of this method.
         *
        ...
        /**
         * Computes 1D inverse DFT of real data leaving the result in <code>a</code> . The physical layout of the input
        ...
        /**
         * Computes 1D inverse DFT of real data leaving the result in <code>a</code> . This method computes the full
         * real inverse transform, i.e. you will get the same result as from <code>complexInverse</code> called with all
         * imaginary part equal 0. Because the result is stored in <code>a</code>, the size of the input array must
         * greater or equal 2*n, with only the first n elements filled with real data.
         *
         * @param a     data to transform
         * @param scale if true then scaling is performed
         */
...
tr2, tr3, tr4, tr5, w1r, w1i, w2r, w2i, w3r, w3i, w4r, w4i;
      ...
      -------------------------------------------------*/
        void radb5(final int ido,
            ...
            final float ti12 = 0.587785252292473248125759255344746634f;
            int i, ic;
            float ci2, ci3, ci4, ci5, di3, di4, di5, di2, cr2, cr3, cr5, cr4, ti2, ti3, ti4, ti5;
            float dr2, dr3, dr4, dr5, tr2, tr3, tr4, tr5, w1r, w1i, w2r, w2i, w3r, w3i, w4r, w4i;
            int iw1, iw2, iw3, iw4;
            iw1 = offset;
            iw2 = iw1 + ido;
            iw3 = iw2 + ido;
    ...
    /*----------------------------------------------------------------------
      ...
      ----------------------------------------------------------------------*/
        ...
        /* isign==-1 for forward transform and+1 for backward transform */ {
            ...
            final float ti12 = 0.587785252292473248125759255344746634f;
            float ci2, ci3, ci4, ci5, di3, di4, di5, di2, cr2, cr3, cr5, cr4, ti2, ti3, ti4, ti5;
            float dr2, dr3, dr4, dr5, tr2, tr3, tr4, tr5;
            int iw1, iw2, iw3, iw4;
...
y6r, y6i, y7r, y7i;
     ...
     * @author Piotr Wendykier (piotr.wendykier@gmail.com)
     */
    private abstract static class ConcurrencyUtils {
        /**
         * Thread pool.
         */
        ...
        /**
         * Sets the number of threads. If n is not a power-of-two number, then the number of threads is set to the
         * closest power-of-two number less than n.
         *
         * @param n
         */
