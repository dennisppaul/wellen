...
/**
 * brief SVF for use in the Resonator Class \n author Ported by Ben Sergentanis date Jan 2021 Ported from
...
public class ResonatorSvf {
    ...
    private static final float kPiPow3 = PI_F * PI_F * PI_F;
    private static final float kPiPow5 = kPiPow3 * PI_F * PI_F;
