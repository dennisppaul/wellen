...
import static wellen.daisysp.DSP.TWOPI_F;
import static wellen.daisysp.DSP.cos;
import static wellen.daisysp.DSP.fabsf;
import static wellen.daisysp.DSP.fclamp;
import static wellen.daisysp.DSP.fmin;
import static wellen.daisysp.DSP.fonepole_return;
import static wellen.daisysp.DSP.kOneTwelfth;
import static wellen.daisysp.DSP.powf;
import static wellen.daisysp.DSP.sin;

/**
 * brief 808 bass drum model, revisited.
 *
 * @author Ben Sergentanis date Jan 2021 Ported from pichenettes/eurorack/plaits/dsp/drums/analog_bass_drum.h \n to an
...
public class AnalogBassDrum {
    ...
    public AnalogBassDrum() {
        Init(Wellen.DEFAULT_SAMPLING_RATE);
    }
    ...
    public float Process(boolean trigger) {
        ...
        final float q = 1500.0f * powf(2.f, kOneTwelfth * decay_ * 80.0f);
        final float tone_f
        ...
        // C40 / R163 / R162 / D83
        pulse_lp_ = fonepole_return(pulse_lp_, pulse, 1.0f / kPulseFilterTime);
        ...
        fm_pulse_lp_ = fonepole_return(fm_pulse_lp_, fm_pulse, 1.0f / kPulseFilterTime);
        ...
        tone_lp_ = fonepole_return(tone_lp_, pulse * exciter_leak + resonator_out, tone_f);
