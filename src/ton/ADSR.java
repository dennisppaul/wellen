...
public class ADSR implements DSPNodeOutput {
    ...
    private float mAttack = Ton.DEFAULT_ATTACK;
    private float mDecay = Ton.DEFAULT_DECAY;
    private float mSustain = Ton.DEFAULT_SUSTAIN;
    private float mRelease = Ton.DEFAULT_RELEASE;
    ...
    public ADSR() {
        this(Ton.DEFAULT_SAMPLING_RATE);
    }
