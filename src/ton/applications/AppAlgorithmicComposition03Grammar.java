...
public class AppAlgorithmicComposition03Grammar extends PApplet {
    ...
    public void setup() {
        ...
        Ton.instrument(1).set_oscillator_type(Ton.OSC_SAWTOOTH);
        Ton.instrument(2).set_oscillator_type(Ton.OSC_SINE);
        Beat.start(this, 240);
    }
    ...
    public static void main(String[] args) {
        PApplet.main(AppAlgorithmicComposition03Grammar.class.getName());
    }
}
